...
| Template                       | File                                                                                | Filename Convention     | When to Use                                                                     |
| :----------------------------- | :---------------------------------------------------------------------------------- | :---------------------- | :------------------------------------------------------------------------------ |
| **Reference / Cheat Sheet**    | [`reference-cheatsheet.md`](.github/page-templates/reference-cheatsheet.md)         | `<name>-cheatsheet.md`  | High-density command matrices, syntax tables, and CLI patterns.                 |
| **Operational Runbook**        | [`how-to-runbook.md`](.github/page-templates/how-to-runbook.md)                     | `<name>-runbook.md`     | Step-by-step procedures with prerequisites, health checks, and fixes.           |
| **Architecture & Explanation** | [`architecture-explanation.md`](.github/page-templates/architecture-explanation.md) | `<name>-explanation.md` | System design, component boundaries, trade-offs, and illustrative code schemas. |
...
## 📑 Sidebar Discovery & Frontmatter Badges

Navigation in Bum Scrolling is dynamically autogenerated from domain directories (`items: [{ autogenerate: { directory: '<domain>' } }]`). You do **not** need to manually register page slugs in `astro.config.mjs`.

Instead, configure the sidebar label, sort order, and archetype badge directly in the page's YAML frontmatter:

```yaml
---
title: "Docker & Podman Compose Cheat Sheet"
description: "High-density command reference, common flags, and practical CLI patterns for Docker Compose and Podman Compose."
sidebar:
